...
class CNNTrainer:
    """Handles training and evaluation of CNN models for Pazhvak speech recognition"""
    ...
    def train_model(self,
        ...
        model = model_fn(input_channels, self.num_classes).to(self.device)
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = data_loader_factory.get_data_loaders(feature_type="mel")  
